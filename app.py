...
<div class="main-header">
    ...
    <p>Tác giả: Lù Thị Vi - Trường PTDTBT Tiểu học Thèn Phàng - ĐT: 0974 046 135</p>
</div>
""", unsafe_allow_html=True)
...
# --- CHÂN TRANG ---
st.markdown("---")
st.markdown("<div style='text-align: center; color: #666;'>© 2025 - Lù Thị Vi - Trường PTDTBT Tiểu học Thèn Phàng - ĐT: 0974 046 135</div>", unsafe_allow_html=True)
